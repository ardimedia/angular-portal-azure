...
export class BladeData<T> extends Blade {
    ...
    constructor(portalService: PortalService, path: string, title: string, subtitle: string = '', width: number = 300) {//$scope: any,
     ...
     */
    saveItem(func: () => Promise<T | Exception> | Promise<T | Exception>, ngForm: any = undefined): (Promise<T | void> | Promise<T | void>) {
        ...
        return (<Promise<T> & Promise<T>>func()).then((data) => {
            this.clearStatusBar();
     ...
     * - call this.onLoadItemsException
     */
    saveObject(func: () => Promise<any | Exception> | Promise<any | Exception>, ngForm: any = undefined): (Promise<any | void> | Promise<any | void>) {
        ...
        return (<Promise<any> & Promise<T>>func()).then((data) => {
            this.clearStatusBar();
            this.isCommandSaveEnabled = true;
            this.onSavedObject();
            return data;
    ...
    deleteItem(func: () => Promise<T | number | void | Exception> | Promise<T | number | void | Exception>, ngForm: any = undefined): (Promise<T | number | void> | Promise<T | number | void>) {
     ...
     */
    execute(message: string, func: () => Promise<T | Exception> | Promise<T | Exception>, ngForm: any = undefined): (Promise<T | void> | Promise<T | void>) {
        if (!this.isFormValid(ngForm) && this.onSaveItemFormValidation()) {
            return;
        }
