...
export class Exception extends ValidationsExceptionDotNet {
    ...
    private static processDotNetException1(response: angular.IHttpPromiseCallbackArg<Exception>): Exception {
        let exception: Exception = new Exception();
    ...
    private static processDotNetException2(response: any): Exception {
        let exception: Exception = new Exception();
