import { BladeArea } from './BladeArea';
...
export class PortalShell extends UserControlBase {
    ...
    constructor(title: string, portalService: PortalService) {
        super(portalService);
        Debug.write('[azureportalng-debug] \'PortalShell\' constructor called.', [this, title, portalService]);
    ...
    initialize() {
        Debug.write('[azureportalng-debug] \'PortalShell.initialize\' called.', [this]);
        this.setObsoleteLayoutProperites();
    }

    setObsoleteLayoutProperites() {
        Debug.write('[azureportalng-debug] \'PortalShell.setObsoleteLayoutProperites\' called.', [this]);
