...
export class BladeList extends BladeData {
    ...
    constructor(portalService: PortalService, path: string, title: string, subtitle: string = '', width: number = 200) {
        ...
        Debug.write('[azureportalng-debug] \'BladeList\' constructor called.', [this, portalService, path, title, subtitle, width]);
    ...
    activate(): void {
        Debug.write('[azureportalng-debug] \'BladeList.activate\' called.', [this]);
        var that = this;
    ...
    onFilter(actual: Object, expected: string): boolean {
        Debug.write('[azureportalng-debug] \'BladeList.filter\' called.', [this, actual, expected]);
    ...
    setObsoleteLayoutProperites() {
        Debug.write('[azureportalng-debug] \'BladeList.setObsoleteLayoutProperites\' called.', [this]);
